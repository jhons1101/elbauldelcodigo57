        ...
        <nav>
            <div class="nav-wrapper">
                ...
                <ul class="hide-on-med-and-down">
                    ...
                    <li class="txtWhite">Grupo de whatsApp +57 316 392 6456</li>
                    <li>
                    ...
                    <li><a href="{{ asset('/login') }}" class="txtWhite">Inicia Sesión</a></li>
                    <li><a href="{{ asset('/register') }}" class="txtWhite">Registrarse</a></li>
                ...
                <ul class="side-nav" id="mobile-demo">
                    ...
                    <li>
                        <a href="https://www.facebook.com/groups/1820752601515497/" class="aMovil" target="_blank">
                            Únete el grupo en facebook
                        </a>
                    </li>
                    <!--<li><a href="{{ asset('/foro') }}">Foro</a></li>-->
                    <li><a href="{{ asset('/login') }}">Inicia Sesion</a></li>
                    <li><a href="{{ asset('/register') }}" class="txtWhite">Registrarse</a></li>

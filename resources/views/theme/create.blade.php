            ...
            <form action="/tema" method="post">
                ...
                <div class="row">
                    <div class="col s12 m6 l6">
                        ...
                        <div class="input-field">
                            <input type="text" class="" id="tit_theme" name="txtTitTheme" value="{{ old('txtTitTheme') }}" maxlength="31">
                    ...
                    <div class="col m6 l6">
                        ...
                        <div class="input-field">
                            <input type="text" class="" id="img_Theme" name="txtImgTheme" value="{{ old('txtImgTheme') }}" maxlength="31">
                ...
                <div class="row">
                    <div class="col s12 m6 l6">
                        ...
                        <div class="input-field">
                            <input type="text" class="" id="tag_Theme" name="txtTagTheme" value="{{ old('txtTagTheme') }}" maxlength="31">

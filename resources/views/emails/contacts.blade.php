...
<html xmlns="http://www.w3.org/1999/xhtml" class="ie">
    ...
    <html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml">
        ...
        <head>
            ...
            <!--[if !mso]><!-->
            <style type="text/css">
                @import url(https://fonts.googleapis.com/css?family=Cabin:400,700,400italic,700italic|Droid+Sans:400,700|Ubuntu:400,700,400italic,700italic);
            </style>
            <link href="https://fonts.googleapis.com/css?family=Cabin:400,700,400italic,700italic|Droid+Sans:400,700|Ubuntu:400,700,400italic,700italic" rel="stylesheet" type="text/css">
            <!--<![endif]-->
            <style type="text/css">
            ...
            <meta property="og:title" content="contacto usuario">
            </meta>
        </head>
        <!--[if mso]>
        <body class="mso">
                        ...
                        <td>
                            ...
                            <div role="section">
                                <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #7cc9db;">
                                        <!--[if (mso)|(IE)]>
                                        <table align="center" cellpadding="0" cellspacing="0" role="presentation">
                                            <tr class="layout-fixed-width" style="background-color: #7cc9db;">
                                                <td style="width: 600px" class="w560">
                                                    ...
                                                    <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                                        ...
                                                        <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                                            <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #80bf2e;" href="https://elbauldelcodigocom.createsend1.com/t/d-l-ihttyhd-l-r/"><img style="border: 0;display: block;height: auto;width: 100%;max-width: 185px;" alt="elbauldelcodigo" width="185" src="https://i1.createsend1.com/ei/d/30/FAA/34D/081351/csfinal/claves-elbauldelcodigo1-9904510a2801453c.png"></a>
                                                        </div>
                                                        ...
                                                        <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                                            <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                <h1 class="size-34" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;font-family: droid sans,apple sd gothic neo,segoe ui,dejavu sans,trebuchet ms,sans-serif;text-align: center;" lang="x-size-34"><span class="font-droid-sans"><span style="color:#ffffff"><strong>{{ trans('message.msgContactMail1') }}</strong></span></span></h1>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--[if (mso)|(IE)]>
                                                ...
                                                <td style="width: 600px" class="w560">
                                                    ...
                                                    <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                                        ...
                                                        <div style="Margin-left: 20px;Margin-right: 20px;">
                                                            <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                <p class="size-16" style="Margin-top: 0;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: center;" lang="x-size-16"><span style="text-align:center">{{ trans('message.msgContactMail2') }}</span><br>
                                                                    <em>{{ trans('message.msgContactMail3') }}</em>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div style="Margin-left: 20px;Margin-right: 20px;">
                                                            <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                                                                <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #80bf2e;font-family: Cabin, Avenir, sans-serif;" href="https://elbauldelcodigocom.createsend1.com/t/d-l-ihttyhd-l-y/">elbauldelcodigo.com</a><![endif]>
                                                                <!--[if mso]>
                                                                <p style="line-height:0;margin:0;">&nbsp;</p>
                                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="https://elbauldelcodigocom.createsend1.com/t/d-l-ihttyhd-l-y/" style="width:174px" arcsize="9%" fillcolor="#80BF2E" stroke="f">
                                                                    <v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px">
                                                                        <center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Cabin,Avenir,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">elbauldelcodigo.com</center>
                                                                    </v:textbox>
                                                                </v:roundrect>
                                                                <![endif]-->
                                                            </div>
                                                        ...
                                                        <div style="Margin-left: 20px;Margin-right: 20px;">
                                                            <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                            <p class="size-13" style="Margin-top: 0;Margin-bottom: 20px;font-size: 13px;line-height: 21px;" lang="x-size-13">
                                                ...
                                                <tr class="layout-email-footer">
                                                    <td style="width: 600px;" class="w560">
                                                        ...
                                                        <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #bdbdbd;font-family: Ubuntu,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                                                <div style="font-size: 12px;line-height: 19px;">
                                                                    <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdbdbd;" href="https://elbauldelcodigocom.createsend1.com/t/d-u-ihttyhd-l-t/">Unsubscribe</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--[if (mso)|(IE)]>

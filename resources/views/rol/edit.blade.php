            ...
            <form action="/rol/{{ $rol->slug }}" method="POST">
                ...
                <div class="row">
                    <div class="col s12 m6 l6">
                        ...
                        <div class="input-field">
                            <input type="text" class="" id="tit_rol" name="txtTitrol" value="{{ $rol->rol_nombre }}{{ old('txtTitrol') }}" maxlength="21">
                ...
                <div class="row">
                    <div class="col s12 m12 l12">
                        ...
                        <div class="input-field">
                            <textarea class="textarea-default" id="desc_rol" name="txtdescrol" rows="5" maxlength="201">{{ $rol->rol_descrip }}{{ old('txtdescrol') }}</textarea>
                ...
                <div class="row">
                    <div class="col s12 m6 l6">
                        <div  class="labeltxt">{{ trans('message.created_at') }}</div>
                        <div class="input-field">
                            {{ $rol->created_at }}
                        </div>
                    </div>

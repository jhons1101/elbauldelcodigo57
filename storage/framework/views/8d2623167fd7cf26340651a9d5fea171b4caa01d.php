        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m12 l9">
                    ...
                    <div class="row bottomCero">
                        <div class="paginadorI">
                            <ul class="pagination">							
                                ...
                                <li class="waves-effect"><a href="') }}<?php echo e(intval($i)+1); ?>"><?php echo e(intval($i)+1); ?></a></li>
                                <?php endfor; ?>
                                <li class="waves-effect"><a href="') }}<?php echo e($cantidadPag); ?>"><i class="icon-circle-right"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <?php endif; ?>
                    <div class="row">
                        <div class="s12 m12 l12">
                            ...
                            <br />
                            <br />
                            <div class="resaltadoRojo"><?php echo e($errores); ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if($errores == ''): ?>
                ...
                <div class="col s12 m12 l3">
                    <div class="row">
                        <?php echo $__env->yieldContent('autor'); ?>                        
                    </div>
                    <br />
                    <div class="row">
                        <?php echo $__env->yieldContent('tematica'); ?>                        
                    </div>
                </div>
            </div>
        </div>

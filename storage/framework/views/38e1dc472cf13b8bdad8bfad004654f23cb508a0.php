...
<html>
	<head>
		<title><?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_tit); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></title>
		<meta charset="UTF-8">
		<link rel="shortcut icon" href="<?php echo e(asset('/img/claves-elbauldelcodigo_ico.png')); ?>" type="image/png" />
		<meta name="description" content="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_desc); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
		<meta name="keywords" content="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_key); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
		<meta name="copyright" content="Copyright © 2014 elbauldelcodigo.com">
		<meta name="author" content="jhons1101">
		<meta name="theme-color" content="#ffffff">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=2">
		
		<meta property="og:title" content="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_tit); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> || elbauldelcodigo">
		<meta property="og:site_name" content="elbauldelcodigo">
		<meta property="og:url" content="www.elbauldelcodigo.com">
		<meta property="og:description" content="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_desc); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
		<meta property="fb:app_id" content="1386964998221435">
		<meta property="og:type" content="website">

		<span itemscope>
			<meta itemprop="name" content="elbauldelcodigo">
			<meta itemprop="description" content="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_desc); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
		</span>
		...
		<meta name="twitter:description" content="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_desc); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
		<meta name="twitter:url" content="http://elbauldelcodigo.com/" />

		<?php echo $__env->yieldContent('img-for-share'); ?>

		<meta property="og:image" content="<?php echo e(asset('/img/elbauldelcodigo.com_front_3.png')); ?>" />
		<link href="<?php echo e(asset('/img/elbauldelcodigo.com_front_3.png')); ?>" rel="image_src" />

		<link rel="stylesheet" href="<?php echo e(asset('/materialize/css/materialize.min.css')); ?>">
		<link rel="stylesheet" href="<?php echo e(asset('/css/tidy.css')); ?>">
		...
		<link rel="stylesheet" href="<?php echo e(asset('/css/tablas-responsive.css')); ?>">
		...
		<script type="text/javascript"><?php echo $__env->yieldContent('javascript'); ?></script>
		<style>img{cursor: pointer;} <?php echo $__env->yieldContent('css'); ?></style>
	</head>
	<body>
			...
			<nav>
			    <div class="nav-wrapper">
					...
					<ul class="hide-on-med-and-down">
						<li class="li-logo">
							<a class="navbar-brand" href="<?php echo e(asset('/')); ?>">
								<img src="<?php echo e(asset('/img/claves-elbauldelcodigo.png')); ?>" alt="ElbauldelCodigo.com" title="Ir al inicio de ElbauldelCodigo.com" class="logo_TC" />
							</a>
						</li>
						<li><h1><a href="<?php echo e(asset('/')); ?>" style="color:white;"><i><b>elbauldelcodigo</b></i></a></h1></li>
						<!--<li><a class="txtWhite" href="<?php echo e(asset('/foro')); ?>">Foro</a></li>
						<li><a class="txtWhite" href="<?php echo e(asset('/login')); ?>">Inicia Sesión</a></li>-->
						<li><a class="txtWhite" href="<?php echo e(asset('/contacto')); ?>">Contacto</a></li>
					...
					<ul class="side-nav" id="mobile-demo">
						...
						<!--<li><a href="<?php echo e(asset('/foro')); ?>">Foro</a></li>
						<li><a href="<?php echo e(asset('/login')); ?>">Inicia Sesión</a></li>-->
						<li><a class="aMovil" href="<?php echo e(asset('/contacto')); ?>">Contacto</a></li>
		...
		<div class="">
			...
			<div class="wow fadeInUp content-card">
				...
				<div class="icon-and-title-flex">
					<div class="cajaTema">
						<div class="texTema">
						<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->tema_txt); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						<input id="tema_txt" type="hidden" value="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->tema_txt); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" />
						</div>
					</div>
					<div class="title-container">
						<h1 class="text-title">
							<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_tit); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<input id="post_tit" type="hidden" value="<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_tit); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" />
						</h1>
						<div class="fecha-blogger">
							Por : 
							<?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<a href="/usuario/<?php echo e($post->usuarios_name); ?>" target="_blank"><?php echo e($post->usuarios_name); ?></a>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</div>
						<div class="fecha-blogger"><?php $__currentLoopData = $Posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($post->post_fec); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
						<div class="fecha-blogger">Tags : <?php echo $__env->yieldContent('TagsPost'); ?></div>
						<input type="hidden" id="flagNuevoComm" value="<?php echo $__env->yieldContent('flagNuevoComm'); ?>" />
					</div>
				</div>
			...
			<div class="wow fadeInUp content-card" style="margin-top: 0;">
			    ...
			    <div id="codefte" class="col s12">
					<main class="text-description">
						<?php echo $__env->yieldContent('CodigoFte'); ?>
						<br /><br /><br /><br />
						<a href="#redesSoc">
						...
						<hr />
						<div class="row">
							<?php echo e(Form::open(array('method' => 'POST', 'name' => 'guardarComentario', 'url' => 'guardarComentario'))); ?>
							...
							<div class="col s12 m12 l12">
								<label for="emailComm" data-error="wrong" data-success="right" class="labelbk">Correo electrónico</label>
									<?php echo e(Form::email('email', null, array(
										'class'			=> 'validate',
										'id' 			=> 'emailComm',
								...
								<span class="erroresLaravel" ><?php echo e($errors->first('email')); ?></span>
							</div>
							<div class="col s12 m12 l12">
							  <label for="commText" class="labelbk">Escribe tu comentario</label>
								<?php echo e(Form::textarea('comentario', null, array(
								...
								<span class="erroresLaravel" ><?php echo e($errors->first('comentario')); ?></span>
								...
								<br />
								<div class="captchaText"><?php echo e($keyCp); ?></div>
								<br />
								<input type="text" name="codecaptcha" width="300px" placeholder="Ingrese el código captcha"/>
								<br />
								<?php echo e(Form::hidden('idPost', null, array('id' => 'idPost'))); ?>

								<?php echo e(Form::button('Guardar Comentario', array(
						...
						<?php else: ?>
							<?php $__currentLoopData = $comm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comentario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col s12 m12 l12">
									<div class="card-panel grey lighten-5 z-depth-1" style="font-family: RobotoDraft,sans-serif; font-size: 17px;">
										<div class="row valign-wrapper">
											<div class="col s3 m2 l1 ">
												<?php if($comentario->usuarios_img == null): ?>
													<img src="<?php echo e(asset('/img/usuarios/img_default.png')); ?>" class="circle responsive-img">
												<?php else: ?>
													<img src="http://elbauldelcodigo.com/img/usuarios/<?php echo e($comentario->usuarios_img); ?>" class="circle responsive-img">
												<?php endif; ?>
											</div>
											<div class="col s9 m10 l11" style="padding-left:10px">
												<div class="ComUser"><?php echo e($comentario->usuarios_name); ?></div>
												<div class="ComUser ComFecha"><?php echo e($comentario->com_fec); ?></div>
												<div class="ComUser ComTexto">
													<?php echo e($comentario->com_texto); ?>
			    ...
			    <div id="pantallazos" class="col s12 m12 l12 txt-center text-description">
					<?php if($totalImg > 0): ?>
						<?php $__currentLoopData = $pantallazo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imagen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($imagen->tipo == 1): ?>
								<p class="resaltadoRojo"><?php echo e($imagen->referencia); ?></p>
								<br />
							<?php elseif($imagen->tipo == 2): ?>
								<p class="resaltadoAzul"><?php echo e($imagen->referencia); ?></p>
								<br />
							<?php elseif($imagen->tipo == 3): ?>
								<p class="resaltadoVerde"><?php echo e($imagen->referencia); ?></p>
								<br />
							<?php else: ?>
								<p class="justificado"><?php echo e($imagen->referencia); ?></p>
							<?php endif; ?>
							<img src="<?php echo e($imagen->ruta); ?>" alt="<?php echo e($imagen->alt_title); ?>" title="<?php echo e($imagen->alt_title); ?>" width="<?php echo e($imagen->width); ?>%">
							<br /><br /><hr /><br />
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					<?php else: ?>
			...
			<div class="wow fadeInUp content-card" style="margin-top: 0;">
				...
				<div class="row">
					<div class="col s12 m12 l12">
						...
						<?php $__currentLoopData = $relacionados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entrada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col s12 m12 l12 relacionado">
								<div class="articuloRelacionado">
									<span class="icon-clipboard"></span> &nbsp; <a href="/" target="_blank"><?php echo e($entrada->post_tit); ?></a>
								</div>
							</div>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				    </div>
